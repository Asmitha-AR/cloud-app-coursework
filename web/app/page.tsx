    ...
    <div className="relative min-h-screen bg-slate-100 text-slate-900 selection:bg-cyan-200/80 flex overflow-hidden">
      ...
      <aside className="relative hidden lg:flex w-72 flex-col border-r border-slate-200/80 bg-white/80 backdrop-blur-xl">
        ...
        <nav className="flex-1 px-4 py-5 space-y-1.5">
          {[
            { label: 'Dashboard', icon: 'M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z', active: true, path: '/' },
            { label: 'Search', icon: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z', active: false, path: '/search' },
          ].map((item, idx) => (
            <button
              key={idx}
