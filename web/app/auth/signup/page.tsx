            ...
            <main className="relative z-10 max-w-6xl mx-auto px-6 md:px-10 pb-10 min-h-[calc(100vh-88px)] flex items-center">
                <div className="w-full grid lg:grid-cols-2 gap-10 lg:gap-14 items-center">
                    <section className="hidden lg:block space-y-6">
                        <p className="text-xs font-bold uppercase tracking-[0.24em] text-cyan-700">Join The Platform</p>
                        <h1 className="text-5xl font-bold leading-[1.05] tracking-tight text-slate-900">
                            Create your account and contribute verified salary insights
                        </h1>
                        <p className="text-lg text-slate-600 max-w-lg">
                            Start sharing salary data, reviewing submissions, and helping build trusted community transparency.
                        </p>
                        <div className="flex items-center gap-3 text-sm text-slate-700">
                            <span className="inline-flex h-8 items-center rounded-full border border-slate-200 bg-white px-3 font-semibold">Share Data</span>
                            <span className="inline-flex h-8 items-center rounded-full border border-slate-200 bg-white px-3 font-semibold">Vote</span>
                            <span className="inline-flex h-8 items-center rounded-full border border-slate-200 bg-white px-3 font-semibold">Build Trust</span>
                        </div>
                    </section>
